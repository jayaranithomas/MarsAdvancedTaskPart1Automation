...
namespace MarsAdvancedTaskPart1NUnitAutomation.Pages.ProfileOverview.ProfileNavigationMenuComponents
{
    ...
    public class SkillsFeatures : CommonDriver
    {
        ...
        SkillsRenderingComponent skillsRendering = new SkillsRenderingComponent();
        ...
        public void AddNewSkill(SkillsDM skillsDM)
        {
            ...
            skillsRendering.AddSkill(skillsDM);
        ...
        public void CancelAddSkillRecord(SkillsDM skillsDM)
        {
            ...
            skillsRendering.SetCancelFlag(cancelFlag);
            Thread.Sleep(2000);
        ...
        {
            skillsRendering.EditSkillRecord(skillsDM);
        ...
        public void UpdateExistingSkillRecordWithExistingSkillName(SkillsDM skillsDM1, SkillsDM skillsDM2)
        {
            ...
            skillsRendering.AddSkill(skillsDM1);
            Thread.Sleep(3000);
